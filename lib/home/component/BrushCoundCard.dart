...
class BrushCountCard extends StatelessWidget {
  ...
  const BrushCountCard({Key? key, required this.myIndex,required this.isClean,required this.duration}) : super(key: key);
              ...
              Row(
                children: [
                  Container(
                    ...
                    child: SvgPicture.asset(image_timeIconBlue),
                  ),
                  Container(
