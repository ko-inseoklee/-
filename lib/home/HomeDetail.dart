...
import 'package:teeth_outsourcing/home/camera/Picture.dart';
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          afterCamera?
          Container(
            height: firstExpanded? 970 : 107 , width: 390,
            child: FlatButton(
            ...
            child: Column(
              ...
              children: [
                Container(
                    ...
                    child: Image.network(image_cautionIcon)
                ),
                Container(
