...
import 'package:teeth_outsourcing/teeth/CameraTeeth.dart';

import 'ImagePictureCard.dart';
...
class _ToggleImagePictureState extends State<ToggleImagePicture> {
  ...
  Widget build(BuildContext context) {
    images = [
      ImagePictureCard(isPicture: isPicture, image: image_thirdTeeth, picture: /*image_27perTeeth*/"images/teeth/45per.png", date: "6월 25일", percent: "45%",),
      ImagePictureCard(isPicture: isPicture, image: image_secondTeeth, picture: /*image_45perTeeth*/"images/teeth/45per.png", date: "5월 28일", percent: "45%",),
      ImagePictureCard(isPicture: isPicture, image: image_firstTeeth, picture: /*image_45perTeeth*/"images/teeth/27per.png", date: "5월 15일", percent: "35%",)
    ];
    if(widget.isAddRecently){
      images.insert(0, ImagePictureCard(isPicture: isPicture, image: image_fourthTeeth, picture: /*image_67perTeeth*/ "images/teeth/67per.png", date: "7월 26일", percent: "67%",));
    }
