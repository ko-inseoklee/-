...
import 'CameraTeeth.dart';
import 'ClinicRecordCard.dart';
import 'ToggleImagePicture.dart';

class TeethDetail extends StatefulWidget {
  const TeethDetail({Key? key}) : super(key: key);

  @override
  State<TeethDetail> createState() => _TeethDetailState();
}
      ...
      body: Container(
        child: ListView(
          children: [
                    ...
                    child: Row(
                      children: [
                        ...
                        Container(
                          ...
                          child: Image.network(image_upRiseIcon),
                        )
                      ],
                    ),
                  ),
            ...
            ToggleImagePicture(isAddRecently: addRecentlyPicture, onToggled: () async {
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                          ...
                                          child: Container(
                                            width: 31, height: 29,
                                            child: Image.network(image_albumIcon),
                                          )
                                      ),Container(
