...
class _SearchFriendsState extends State<SearchFriends> {
                ...
                child: Stack(
                  children: [
                    Container(
                      ...
                      child: Image.network(image_brush),
                    ),
                    Container(
                      margin: EdgeInsets.only(left: 80, top: 27),
                      child: Image.network(image_brushBar),
                    ),
                  ],
                ),
              ),
  ...
  Widget SearchedFriendList(){
    ...
    return Container(
      height: 550,
      child: ListView.builder(padding: EdgeInsets.zero,itemCount: searchedList.length ,itemBuilder: (context, index){
